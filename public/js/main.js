...
function closeUpdateTugas() {
    var Box = document.getElementById("uploadTugas");
    var overlay = document.getElementById("overlay");
    overlay.classList.remove("overlay");
    Box.style.opacity = 0;
    var body = document.getElementsByTagName("body")[0];
...
function closeUpdateTugas2() {
    var Box = document.getElementById("uploadTugas2");
    var overlay = document.getElementById("overlay");
    overlay.classList.remove("overlay");
    Box.style.opacity = 0;
    var body = document.getElementsByTagName("body")[0];
...
function showUploadBox() {
    var uploadTugas = document.getElementById("uploadTugas");
    var overlay = document.getElementById("overlay");
    overlay.classList.add("overlay");
    uploadTugas.style.display = "block";
    uploadTugas.style.opacity = 1;
    overlay.style.display = "block";
    var body = document.getElementsByTagName("body")[0];
    body.style.overflow = "hidden";
}

function showUploadBox2() {
    var uploadTugas = document.getElementById("uploadTugas2");
    var overlay = document.getElementById("overlay");
    overlay.classList.add("overlay");
    uploadTugas2.style.display = "block";
    uploadTugas2.style.opacity = 1;
    overlay.style.display = "block";
    var body = document.getElementsByTagName("body")[0];
    body.style.overflow = "hidden";
}
